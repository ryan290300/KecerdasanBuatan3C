# -*- coding: utf-8 -*-
"""
Created on Mon Mar  8 19:48:11 2021
...
iris = datasets.load_iris() 
#untuk memuat dan memasukkan dataset iris ke variable bernama irid
digits = datasets.load_digits() 
...
dump(clf, '1184003.joblib')
#menyimpan model kedalam 1174027.joblib
clf = load('1184003.joblib')
#memanggil model 1184003
print(clf)
